...
function project {
    ...
    module_list=("PSU" "CPE" "AIA" "MAT" "MUL" "DOP" "SEC" "PRO" "WEB")
...
function main {
    ...
    echo "3 - Projet perso"
    echo "4 - Quitter"
    choice=$(prompt_user "Entrez votre choix (1, 2, 3 ou 4)")
    while ! is_valid_input "$choice" 1 4; do
        echo "Erreur: Veuillez entrer un choix valide (1, 2, 3 ou 4)."
        choice=$(prompt_user "Entrez votre choix (1, 2, 3 ou 4)")
    done
